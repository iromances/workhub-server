...
final class WorkItemStatusRules {
    ...
    static final String STATUS_PAUSED = "已暂停";
    ...
    private static final Set<String> CLOSING_STATUSES = Set.of(STATUS_COMPLETED, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED);
    ...
    private static final Map<String, List<String>> ALLOWED_TRANSITIONS = Map.of(
            INITIAL_STATUS, List.of(STATUS_PENDING_EVALUATION, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED),
            STATUS_PENDING_EVALUATION, List.of(STATUS_PENDING_SCHEDULING, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED),
            STATUS_PENDING_SCHEDULING, List.of(STATUS_IN_DEVELOPMENT, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED),
            STATUS_IN_DEVELOPMENT, List.of(STATUS_TESTING, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED),
            STATUS_TESTING, List.of(STATUS_PENDING_RELEASE, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED),
            STATUS_PENDING_RELEASE, List.of(STATUS_COMPLETED, STATUS_REJECTED, STATUS_SUSPENDED, STATUS_PAUSED)
    );
