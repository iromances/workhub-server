...
public class IntakeStructuredFieldNormalizer {
    ...
    private static final Map<String, String> NORMALIZED_KEYS = Map.ofEntries(
            ...
            Map.entry("预估开发日期", "planned_development_start_date"),
            Map.entry("实际开发开始日期", "development_started_date"),
            Map.entry("开发日期", "development_started_date"),
            Map.entry("研发开始日期", "development_started_date"),
            Map.entry("实际开发完成日期", "actual_completed_date"),
            Map.entry("预估提测日期", "planned_testing_start_date"),
            Map.entry("实际提测日期", "testing_started_date"),
            Map.entry("实际测试完成日期", "actual_testing_completed_date"),
            Map.entry("预估上线日期", "planned_release_date"),
            Map.entry("实际上线日期", "released_date"),
            Map.entry("上线日期", "released_date"),
            Map.entry("预约验收日期", "scheduled_acceptance_date"),
            Map.entry("实际验收日期", "acceptance_date"),
            Map.entry("验收日期", "acceptance_date"),
            Map.entry("实际开发工时", "actual_effort"),
            Map.entry("实际测试工时", "actual_testing_effort"),
