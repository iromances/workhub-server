...
本目录沉淀 WorkHub 的业务边界、架构约束、接口说明和研发方案规范。后续 AI 与人工开发应优先通过本索引定位规则来源。
...
- 做功能判断时，先读 `project-charter.md` 和 `backend-architecture.md`，确认需求仍在当前业务范围和架构边界内。
...
- `mcp-capabilities.md`：WorkHub MCP 只读能力清单和工具边界。
