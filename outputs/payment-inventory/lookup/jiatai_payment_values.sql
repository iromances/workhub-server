SELECT
  'jiatai.mer_channel_config' AS source_table,
...
FROM jiatai_amp_payment.mer_channel_config
WHERE status = 1 AND COALESCE(is_delete, 0) = 0 AND COALESCE(is_cancel, 0) = 0
  AND product_type = 'REMIT'
  AND mer_id IN ('HZF000036','HZF000118','HZF000140','HZF000141','HZF000142')
ORDER BY cooperation_code, channel_code;
